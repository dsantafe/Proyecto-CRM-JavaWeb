...
public class clsPosiblesClientes {
    ...
    public String createPosiblesCliente(Models.clsPosiblesClientes obclsPosiblesClientes) {
        try {

            PreparedStatement ps = conn.prepareStatement("{ call spInsertarPosiblesCliente(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)}");
    ...
    public String updatePosiblesCliente(Models.clsPosiblesClientes obclsPosiblesClientes) {
        try {
